    ...
    <div class="mil-banner-content mil-center mil-up">
        <div class="container">
            <ul class="mil-breadcrumbs mil-center mil-mb-60">
                ...
                <li><a href="{{ route('user.newslatter') }}">Newslatter</a></li>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-12">
                ...
                <div class="mil-image-frame mil-horizontal mil-up">
                    <img src="{{asset('assets/img/blog/3.jpg')}}" alt="Publication cover" class="mil-scale" data-value-1=".90" data-value-2="1.15">
                </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <div class="mil-image-frame mil-horizontal mil-up mil-mb-30">
                            <img src="{{asset('assets/img/blog/4.jpg')}}" alt="Publication cover">
                        </div>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="mil-image-frame mil-horizontal mil-up mil-mb-60">
                            <img src="{{asset('assets/img/blog/7.jpg')}}" alt="Publication cover">
                        </div>
